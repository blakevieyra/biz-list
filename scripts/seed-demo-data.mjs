...
const BUSINESSES = [
  {
    ...
    isHiring: true,
    services: [
      { name: "Wholesale loaves", description: "Sourdough and country loaves for cafés, restaurants, and farmers markets. Baked fresh Tuesday through Sunday.", price: "From $6/loaf", quantity: "Min. 12 loaves per order · 48-hour notice required", imageUrl: DEMO_IMAGES.bakery },
      { name: "Event catering", description: "Custom pastry trays for corporate breakfasts, pop-ups, and private events. Seasonal flavors available.", price: "From $80/tray", quantity: "Trays feed 20–40 guests · book 72 hrs ahead", imageUrl: DEMO_IMAGES.bakery2 },
    ],
  ...
  },
  {
    ...
    isHiring: false,
    services: [
      { name: "Contract review", description: "Flat-fee review of vendor agreements, client contracts, and NDAs. Clear summary with redlines included.", price: "$299 flat fee", quantity: "Delivered in 3–5 business days · unlimited Q&A", imageUrl: DEMO_IMAGES.legal },
      { name: "Lease review", description: "Commercial and pop-up lease analysis with negotiation support. We flag hidden clauses and propose counterterms.", price: "$399 flat fee", quantity: "Covers leases up to 20 pages · one revision round", imageUrl: DEMO_IMAGES.legal },
    ],
  ...
  },
  {
    ...
    isHiring: true,
    services: [
      { name: "Pop-up retail", description: "Short-term shared shelf space in our Round Rock storefront. Perfect for local makers testing a new product line.", price: "From $150/month", quantity: "2–4 ft of dedicated shelf · 30 and 90-day terms", imageUrl: DEMO_IMAGES.retail },
      { name: "Vendor market booth", description: "Reserve a 10×10 booth at our seasonal maker markets. Includes table, signage space, and co-op social promotion.", price: "$75 per market day", quantity: "One booth per vendor · setup 1 hr before open", imageUrl: DEMO_IMAGES.flyerMarket },
    ],
  ...
  },
  {
    ...
    isHiring: true,
    services: [
      { name: "Corporate wellness", description: "20-minute on-site stretch and mobility sessions for office teams. Reduces injury and improves focus — no equipment needed.", price: "From $199/mo", quantity: "Teams of 8–30 people · 2 sessions/week included", imageUrl: DEMO_IMAGES.flyerFitness },
      { name: "Small-group training", description: "Structured strength and conditioning in groups of 4–6. All fitness levels welcome — programming adjusts weekly.", price: "$149/mo", quantity: "4 sessions/week · max 6 per group", imageUrl: DEMO_IMAGES.fitness },
    ],
  ...
  },
  {
    ...
    isHiring: false,
    services: [
      { name: "Menu & signage printing", description: "Laminated menus, chalkboard inserts, window clings, and A-frame signs. Rush turnaround available for grand openings.", price: "From $89", quantity: "Min. order 10 pieces · same-day rush available", imageUrl: DEMO_IMAGES.print },
      { name: "Event banners", description: "Weatherproof vinyl banners for outdoor markets, pop-ups, and storefronts. Grommets and hardware included.", price: "From $120", quantity: "Sizes up to 4×8 ft · 48-hr standard · 24-hr rush", imageUrl: DEMO_IMAGES.flyerPrint },
    ],
