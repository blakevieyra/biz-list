...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      <PageHeader
        title="Terms of use"
        description="Rules for using AllConnect."
      />
      <Card className="space-y-4 text-sm leading-relaxed text-muted">
        <p>
          By using AllConnect you agree to post accurate business information, respect other members, and
          comply with applicable laws. Paid plans renew according to your billing selection until
          canceled.
        </p>
        <p>
          AllConnect provides a platform for discovery and connection. We do not guarantee hiring
